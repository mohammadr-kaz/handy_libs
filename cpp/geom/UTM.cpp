...
double hl::geom::DegToRad(double deg)
{
  return (deg / 180.0 * pi);
}
...
double hl::geom::RadToDeg(double rad)
{
  return (rad / pi * 180.0);
}
...
double hl::geom::ArcLengthOfMeridian(double phi)
{
...
double hl::geom::UTMCentralMeridian(int zone)
{
  double cmeridian;
...
double hl::geom::FootpointLatitude(double y)
{
...
void hl::geom::MapLatLonToXY(double phi, double lambda, double lambda0, double &x, double &y)
{
...
void hl::geom::MapXYToLatLon(double x, double y, double lambda0, double &phi, double &lambda)
{
...
int hl::geom::LatLonToUTMXY(double lat, double lon, int zone, double &x, double &y)
{
  if ((zone < 1) || (zone > 60))
...
// Returns:
// The function does not return a value.
void hl::geom::UTMXYToLatLon(double x, double y, int zone, bool southhemi, double &lat, double &lon)
{
  double cmeridian;
...
int hl::geom::getUTMZone(double latitude, double longitude)
{
